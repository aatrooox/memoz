...
INSERT INTO "new_b_memos" ("content", "create_ts", "defalt_floded", "flod_tip", "id", "tags", "uid", "updated_ts", "user_id", "visible") SELECT "content", "create_ts", "defalt_floded", "flod_tip", "id", "tags", "uid", "updated_ts", "user_id", "visible" FROM "b_memos";
DROP TABLE "b_memos";
